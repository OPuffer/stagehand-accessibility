    ...
    public static  List<List<List<string>>> scripts = new List<List<List<string>>>
    {
        ...
        new List<List<string>>
        {
            new List<string>
            {
                ...
                "And we realize he survived…(fade to black)…(fade back in)…Now we cut down to [location], where [character 1] is now consulting with [character 2] and it looks like they are just having a conversation about [plural noun 1].",
            ...
            new List<string>()
            {
                "[first name 1] [last name 1]'s been [past tense verb] everything on a silver platter. His cushy job at his dad's [noun] company, handed to him.",
                "His 60-foot boat, [first name 1]'s boat?, [past tense verb] to him when he was [number].",
            ...
            new List<string>()
            {
                "To be fair, you have to have a very high IQ to understand [Name 1] and [Name 2].", 
                ...
                "As a consequence, people who dislike [Name 1] and [Name 2] truly ARE [plural noun]."
            }
        },
        ...
        new List<List<string>>
        {
            new List<string>
            {
                ...
                "Uh, [proper noun]? [past tense verb] them [number] cases of [noun]. Or, were you talking about [proper noun 2]? Because I didn’t close that one yet, but I’m hoping I’ve got a voicemail waiting for me."
            },
            new List<string>()
            {
                ...
                "Not so fast",
                "pu-put it on.",
                "We received a tip that you, [First Name] “born and raised” [Last Name] were not born in [Location 1].",
                "What?",
